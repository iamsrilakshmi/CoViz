...
def current_updates(c):
	...
	rx = c.recovered.sum()
	ax = c.active.sum()
	st.markdown(f"<h2 style='text-align: center; color: red;font-weight:bold;'>Confirmed : {cx} </h2>", unsafe_allow_html=True)
	st.markdown(f"<h2 style='text-align: center; color: brown;font-weight:bold;'>Deaths : {dx} </h2>", unsafe_allow_html=True)
	st.markdown(f"<h2 style='text-align: center; color: green;font-weight:bold;'>Recovered : {rx} </h2>", unsafe_allow_html=True)
	st.markdown(f"<h2 style='text-align: center; color: blue;font-weight:bold;'>Active : {ax} </h2>", unsafe_allow_html=True)
	...
	st.markdown("<h3 style='text-align: center; color: blue;font-weight:bold;'> Countries with Large Number of Recovered Cases</h2>", unsafe_allow_html=True)
	...
	st.markdown("<h3 style='text-align: center; color: red;font-weight:bold;'> Countries with Many Deaths</h2>", unsafe_allow_html=True)
